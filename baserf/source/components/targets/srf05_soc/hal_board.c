...
void halBoardInit(void)
{
    ...
    MCU_IO_DIR_OUTPUT(HAL_BOARD_IO_LED_1_PORT, HAL_BOARD_IO_LED_1_PIN);
    HAL_LED_CLR_1();
//    MCU_IO_DIR_OUTPUT(HAL_BOARD_IO_LED_2_PORT, HAL_BOARD_IO_LED_2_PIN);//by qiujie tech
//    HAL_LED_CLR_2();
  ...
  //  MCU_IO_DIR_OUTPUT(HAL_BOARD_IO_LED_4_PORT, HAL_BOARD_IO_LED_4_PIN);
...
#endif
   //BUZZER
    MCU_IO_DIR_OUTPUT(HAL_BOARD_IO_BUZZER_PORT, HAL_BOARD_IO_BUZZER_PIN);
    HAL_BUZZER_SET();
    // Buttons
   ...
   // halLcdSpiInit();CC2530 BasicRF（点对点通信）
 //   halLcdInit();
